...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { address: @apartment.address, bathrooms: @apartment.bathrooms, bedrooms: @apartment.bedrooms, city: @apartment.city, state: @apartment.state } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, bathrooms: @apartment.bathrooms, bedrooms: @apartment.bedrooms, city: @apartment.city, state: @apartment.state } }
